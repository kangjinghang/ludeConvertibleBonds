...
可以看到 最高价_负相关 相对表现更好。
依次是 最高价_负相关、开盘价_负相关、前收盘价_负相关、收盘价_负相关、最低价_负相关、5日均价_负相关
...
可以看到 最高价_负相关 相对表现更好。
依次是 最高价_负相关、开盘价_负相关、前收盘价_负相关、最低价_负相关、5日均价_负相关、收盘价_负相关

2025.08.11 v2 版 因子分析
     factor1   factor2  correlation
12   收盘价_负相关   最低价_负相关     0.995990
11   开盘价_负相关   最高价_负相关     0.995967
1   5日均价_负相关   开盘价_负相关     0.992149
4   5日均价_负相关   最高价_负相关     0.990278
3   5日均价_负相关   最低价_负相关     0.989917
10   开盘价_负相关   最低价_负相关     0.988445
13   收盘价_负相关   最高价_负相关     0.986989
2   5日均价_负相关   收盘价_负相关     0.986872
14   最低价_负相关   最高价_负相关     0.986722
9    开盘价_负相关   收盘价_负相关     0.985286
5   前收盘价_负相关   开盘价_负相关     0.962415
0   5日均价_负相关  前收盘价_负相关     0.957395
8   前收盘价_负相关   最高价_负相关     0.957148
7   前收盘价_负相关   最低价_负相关     0.952508
6   前收盘价_负相关   收盘价_负相关     0.947009

            年化收益率  夏普比率 索提诺比率 卡玛比率   胜率        盈亏比
最低价	    0.081800	0.503	0.647	0.212	0.507500	1.071900
5日均价	    0.099400	0.571	0.731	0.272	0.510200	1.063400
收盘价	    0.106800	0.630	0.814	0.290	0.510200	1.082300
最高价	    0.089300	0.528	0.678	0.223	0.514300	1.052300
前收盘价	    0.175300	0.880	1.165	0.556	0.510200	1.151500
纯债溢价率	0.130400	0.778	0.962	0.430	0.529300	1.045700
开盘价	    0.096900	0.562	0.718	0.255	0.514300	1.054800


2022-08-01 至 None 周度收益分析
5日均价_负相关 的周度累计收益率 1.3309749952794956大于基准累计收益率 1.117890806681954
前收盘价_负相关 的周度累计收益率 1.6314737497893008大于基准累计收益率 1.117890806681954
开盘价_负相关 的周度累计收益率 1.324302726432599大于基准累计收益率 1.117890806681954
收盘价_负相关 的周度累计收益率 1.3596945464048205大于基准累计收益率 1.117890806681954
最低价_负相关 的周度累计收益率 1.2686384726606774大于基准累计收益率 1.117890806681954
最高价_负相关 的周度累计收益率 1.2961971977946352大于基准累计收益率 1.117890806681954

可以看到 2022-08-01-2025-08-08 前收盘价_负相关表现更好。
依次是 前收盘价_负相关、收盘价_负相关、5日均价_负相关、开盘价_负相关、最高价_负相关、最低价_负相关
...
# 备用 股息率_负相关、转股价值_负相关、强赎触发比率_正相关、涨跌停标记率_正相关、理论溢价率_正相关、强赎触发比率_负相关
# 上市天数_负相关 和 剩余年限_正相关 强烈正相关

# 11    收盘价_负相关  纯债溢价率_负相关     0.960951
# 1   到期收益率_正相关    收盘价_负相关     0.953156
# 4   到期收益率_正相关  纯债溢价率_负相关     0.922041
effective_factors_v2 = ['理论偏离度_负相关', '转股溢价率_负相关', '双低_负相关', '收盘价_负相关', '正股总市值_负相关',
                        '股息率_负相关','转股价值_负相关','强赎触发比率_正相关','涨跌停标记率_正相关','理论溢价率_正相关','强赎触发比率_负相关'
                        '剩余年限_正相关',
                        ]
#  收盘价_负相关 和 到期收益率_正相关 、纯债溢价率_负相关 强烈正相关
...
def analyze_correlation(df):
    ...
    df = df[df['factor'].isin(effective_factors_v2)]
...
def analyze_week_returns_v2(df):
    """
    新禄得
    分析 2022 年 8 月 1 日至今的周度收益
    """
    df = df[df['return_type'] == '周度'].copy()
    # print(df)

    effective_factors = analyze_week_returns(df, '2022-08-01')
...
if __name__ == '__main__':
    ...
    try:
        ...
        # 新禄得
        analyze_week_returns_v2(df_returns)
        analyze_annual_returns(df_returns)

        # 新禄得结论
        # 有效因子: ['5日均价_负相关', '上市天数_负相关', '修正溢价率_负相关', '到期收益率_正相关', '前收盘价_负相关', '剩余市值_正相关', '剩余市值_负相关', '剩余年限_正相关', '剩余规模_正相关', '双低_负相关', '发行规模_正相关', '市盈率_正相关', '市盈率_负相关', '年化波动率_负相关', '开盘价_负相关', '强赎触发比率_正相关', '强赎触发比率_负相关', '收盘价_负相关', '最低价_负相关', '最高价_负相关', '正股年化波动率_负相关', '正股总市值_负相关', '涨跌停标记率_正相关', '理论偏离度_负相关', '理论溢价率_正相关', '纯债价值_正相关', '纯债价值_负相关', '纯债溢价率_负相关', '股息率_正相关', '股息率_负相关', '负债率_负相关', '转股价值_负相关', '转股溢价率_负相关']

        # 2022起至今每年超过基准收益的因子: {'正股总市值_负相关', '前收盘价_负相关', '上市天数_负相关', '纯债溢价率_负相关', '剩余年限_正相关'}
        # 2023起至今每年超过基准收益的因子: {'正股总市值_负相关', '前收盘价_负相关', '上市天数_负相关', '纯债溢价率_负相关', '剩余年限_正相关'}
        # 2024起至今每年超过基准收益的因子: {'5日均价_负相关', '涨跌停标记率_正相关', '理论偏离度_负相关', '股息率_负相关', '修正溢价率_负相关', '理论溢价率_正相关', '转股溢价率_负相关', '前收盘价_负相关', '收盘价_负相关', '最低价_负相关', '上市天数_负相关', '到期收益率_正相关', '转股价值_负相关', '开盘价_负相关', '最高价_负相关', '正股总市值_负相关', '强赎触发比率_负相关', '纯债溢价率_负相关', '剩余年限_正相关', '强赎触发比率_正相关'}
        # 2025起至今每年超过基准收益的因子: {'5日均价_负相关', '涨跌停标记率_正相关', '开盘价_负相关', '纯债价值_负相关', '最高价_负相关', '理论偏离度_负相关', '股息率_负相关', '修正溢价率_负相关', '理论溢价率_正相关', '正股总市值_负相关', '转股溢价率_负相关', '前收盘价_负相关', '收盘价_负相关', '强赎触发比率_负相关', '最低价_负相关', '上市天数_负相关', '纯债溢价率_负相关', '剩余年限_正相关', '强赎触发比率_正相关', '负债率_负相关', '到期收益率_正相关', '转股价值_负相关', '市盈率_正相关'}
